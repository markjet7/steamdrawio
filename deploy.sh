...
git add .
git commit -m "Update package to version 0.7.1" # Replace "x.y.z" with your new version number. Remember to update setup.py and pyproject.toml before running this command

git tag -a v0.7.1 -m "Update package to version 0.7.1" # Replace "x.y.z" with your new version number. Remember to update setup.py and pyproject.toml before running this command
